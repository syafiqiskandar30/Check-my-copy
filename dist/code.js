          ...
          contents: [
            {
              parts: [
                {
                  text: "You are a UX writing assistant. Rewrite the following copy into 3 short, mobile-friendly headings in lower case (2\u20136 words each). Tone: warm, appreciative, enthusiastic. Avoid emojis unless asked.\n\nUser copy:\n" + text
                }
              ]
            }
          ]
